...
client.on(discord_js_1.Events.ClientReady, function (c) {
    console.log('[Client]: Client ready!');
    console.log("[Client]: Logged in as ".concat(c.user.username));
});
client.on(discord_js_1.Events.MessageReactionAdd, function (m) { return __awaiter(void 0, void 0, void 0, function () {
    var e_1, e_2;
